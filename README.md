...
Реализация на базе библиотеки Selenium. Аналогичная реализация на базе BeautifulSoup доступна [по ссылке](https://github.com/JuliiaZhuravleva/3_3_1_hh_vacancies_parsing_BeautifulSoup)
